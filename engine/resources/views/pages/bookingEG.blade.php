                ...
                <div class="container text-center pb-5">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page">Elysian Gardens</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="row g-3">
                    <div class="col-12 text-center">
                        <img class="img-fluid rounded wow zoomIn" data-wow-delay="0.1s" src="engine/resources/views/pages/img/4.jpeg">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <form action="{{ route('checkout') }}" method="post">
                    ...
                    <div class="mb-3">
                        <input type="number" class="form-control" id="harga" name="harga" value="2000000" hidden>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <input type="text" class="form-control" id="hotelName" name="hotelName" value="Elysian Gardens Resort" hidden>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="hotelName1" name="hotelName1" value="bookeg" hidden>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="hotelName2" name="hotelName2" value="ELYSIAN GARDENS" hidden>
                    </div>
                    <div class="mb-3">
