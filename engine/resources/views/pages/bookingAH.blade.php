                ...
                <div class="container text-center pb-5">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('super') }}">Super</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Alpine Haven</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6">
                ...
                <h1 class="mb-4">Alpine Haven <span class="text-primary text-uppercase">Lodge</span></h1>
                <p class="mb-4">Green Valley Residence, Jl. Pemandangan Indah, No. 101</p>
                <p class="mb-4">Terletak di ketinggian yang indah, hotel ini menawarkan kenyamanan ala kabin kayu dengan pemandangan pegunungan yang menakjubkan.</p>
            ...
            <div class="col-lg-6">
                <div class="row g-3">
                    <div class="col-12 text-center">
                        <img class="img-fluid rounded wow zoomIn" data-wow-delay="0.1s" src="engine/resources/views/pages/img/5.jpeg">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <form action="{{ route('checkout') }}" method="post">
                    ...
                    <div class="mb-3">
                        <input type="number" class="form-control" id="harga" name="harga" value="2350000" hidden>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="type" name="type" value="Super Deluxe" hidden>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="type1" name="type1" value="super" hidden>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="type2" name="type2" value="SUPER" hidden>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="hotelName" name="hotelName" value="Alpine Haven Lodge" hidden>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="hotelName1" name="hotelName1" value="bookah" hidden>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="hotelName2" name="hotelName2" value="ALPINE HAVEN" hidden>
                    </div>
                    <div class="mb-3">
