                ...
                <div class="container text-center pb-5">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('exec') }}">Executive</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Royal Elegance</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6">
                ...
                <h1 class="mb-4">Royal Elegance <span class="text-primary text-uppercase">Hotel</span></h1>
                <p class="mb-4">Jl. Cermin Indah, Kelurahan Damai Jaya, Kecamatan Serenity</p>
                <p class="mb-4">Kehangatan kerajaan dan keanggunan modern bertemu di Royal Elegance Hotel. Dengan interior yang megah, kolam renang indoor, dan layanan limusin eksklusif.</p>
            ...
            <div class="col-lg-6">
                <div class="row g-3">
                    <div class="col-12 text-center">
                        <img class="img-fluid rounded wow zoomIn" data-wow-delay="0.1s" src="engine/resources/views/pages/img/room-2.jpg">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <form action="{{ route('checkout') }}" method="post">
                    ...
                    <div class="mb-3">
                        <input type="number" class="form-control" id="harga" name="harga" value="750000" hidden>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="type" name="type" value="Executive Suite" hidden>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="type1" name="type1" value="exec" hidden>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="type2" name="type2" value="EXECUTIVE" hidden>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="hotelName" name="hotelName" value="Royal Elegance Hotel" hidden>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="hotelName1" name="hotelName1" value="bookre" hidden>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="hotelName2" name="hotelName2" value="ROYAL ELEGANCE" hidden>
                    </div>
                    <div class="mb-3">
