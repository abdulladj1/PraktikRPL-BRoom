                ...
                <div class="container text-center pb-5">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page">Urban Oasis</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6">
                ...
                <h1 class="mb-4">Urban Oasis <span class="text-primary text-uppercase">Suites</span></h1>
                <p class="mb-4">Blok C2, Perumahan Mawar Sari, Desa Sentosa</p>
                <p class="mb-4">Kamar-kamar berdesain modern, spa eksklusif, dan lounge atap dengan pemandangan kota membuatnya menjadi tempat yang ideal untuk bisnis dan liburan.</p>
            ...
            <div class="col-lg-6">
                <div class="row g-3">
                    <div class="col-12 text-center">
                        <img class="img-fluid rounded wow zoomIn" data-wow-delay="0.1s" src="engine/resources/views/pages/img/6.jpeg">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <!-- Ubah action untuk merujuk ke route checkout -->
                <form action="{{ route('checkout') }}" method="post">
                    @csrf <!-- Tambahkan CSRF token untuk keamanan form -->

                    <div class="mb-3">
                        <input type="number" class="form-control" id="harga" name="harga" value="400000" hidden>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <input type="text" class="form-control" id="hotelName" name="hotelName" value="Urban Oasis Suites" hidden>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="hotelName1" name="hotelName1" value="bookuo" hidden>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="hotelName2" name="hotelName2" value="URBAN OASIS" hidden>
                    </div>
                    <div class="mb-3">
