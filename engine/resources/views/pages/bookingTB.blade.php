                ...
                <div class="container text-center pb-5">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page">Tranquil Bay</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6">
                ...
                <h1 class="mb-4">Tranquil Bay <span class="text-primary text-uppercase">Hotel</span></h1>
                <p class="mb-4">Jl. Harmoni Selatan, Kavling 45, Perumahan Bahagia Abadi</p>
                <p class="mb-4">Terletak di teluk yang tenang, Tranquil Bay Hotel menawarkan pengalaman liburan yang santai.</p>
            ...
            <div class="col-lg-6">
                <div class="row g-3">
                    <div class="col-12 text-center">
                        <img class="img-fluid rounded wow zoomIn" data-wow-delay="0.1s" src="engine/resources/views/pages/img/2.jpg">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <form action="{{ route('checkout') }}" method="post">
                    ...
                    <div class="mb-3">
                        <input type="number" class="form-control" id="harga" name="harga" value="1750000" hidden>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <input type="text" class="form-control" id="hotelName" name="hotelName" value="Tranquil Bay Hotel" hidden>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="hotelName1" name="hotelName1" value="booktb" hidden>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="hotelName2" name="hotelName2" value="TRANQUIL BAY" hidden>
                    </div>
                    <div class="mb-3">
